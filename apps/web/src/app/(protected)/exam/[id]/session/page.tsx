      ...
      <main className="relative z-10 flex-1 overflow-y-auto px-6 py-8 md:py-12">
        <div className="max-w-3xl mx-auto h-full flex flex-col">
          ...
          <div className="mb-8" aria-live="polite">
            {/* Show image for PRACTICAL questions */}
            {question.imageUrl && (
              <div className="mb-6 rounded-2xl overflow-hidden border border-[var(--border-subtle)] bg-[var(--bg-elevated)]">
                <img
                  src={question.imageUrl}
                  alt={question.imageAlt || 'Clinical examination image'}
                  className="w-full max-h-80 object-contain"
                />
                {question.imageAlt && (
                  <div className="px-4 py-2 text-xs text-[var(--text-muted)] font-ui italic border-t border-[var(--border-subtle)]">
                    {question.imageAlt}
                  </div>
                )}
              </div>
