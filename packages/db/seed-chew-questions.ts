...
async function main() {
  ...
  const files = [
    'chew-objective.json',
    'chew-objective-extra.json',
    'chew-objective-extra-2.json',
    'chew-theory.json',
    'chew-theory-extra.json',
    'chew-practical.json',
    'chew-practical-extra.json'
  ];
  let totalInserted = 0;
  ...
  for (const file of files) {
    ...
    console.log(`Seeding CHEW questions... ${totalInserted}/410 inserted`);
  }
