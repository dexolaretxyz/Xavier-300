...
async function main() {
  ...
  const certifications = [
    ...
    { slug: 'chew-paper1-objective', domainSlug: 'nigerian-professional-exams', name: 'CHPRBN Paper 1 — Objective (Professional Practice)', description: 'Community Health National Qualifying Examination Paper 1 — Objective Section', difficulty: Difficulty.MEDIUM, questionCount: 90 },
    { slug: 'chew-paper2-objective', domainSlug: 'nigerian-professional-exams', name: 'CHPRBN Paper 2 — Objective (Maternal & Child Health)', description: 'Community Health National Qualifying Examination Paper 2 — Objective Section', difficulty: Difficulty.MEDIUM, questionCount: 90 },
    { slug: 'chew-paper3-objective', domainSlug: 'nigerian-professional-exams', name: 'CHPRBN Paper 3 — Objective (Environmental & Community)', description: 'Community Health National Qualifying Examination Paper 3 — Objective Section', difficulty: Difficulty.MEDIUM, questionCount: 90 },
